...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Automaticamente no próprio site após o pagamento (apenas). Em menos de 60 segundos você já tem acesso ao seu material para baixar.",
    },
    {
      q: "Tem garantia?",
      ...
      <section className="relative overflow-hidden pt-16 pb-20 md:pt-24 md:pb-28">
        ...
        <div className="container relative">
          ...
          <h1 className="text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-foreground leading-tight max-w-4xl mx-auto">
            EasyCred –{" "}
            <span className="text-primary">Crédito Fácil</span>,{" "}
            Dinheiro na Conta e{" "}
          ...
          <p className="mt-6 text-center text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            ...
            <strong className="text-primary">+47 mil brasileiros</strong> já saíram do vermelho ou
            começaram a ganhar dinheiro extra com nossos materiais.
          </p>
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">
                  Os produtos que mais estão vendendo agora no EasyCred. São os mesmos métodos que a galera está usando nos grupos de WhatsApp e comunidades do Serasa.
                </p>
              </div>
            </div>
        ...
        <div className="container">
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="h-72 rounded-xl bg-card border border-white/5 animate-pulse" />
              ))}
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="flex flex-col md:flex-row items-start justify-between gap-8">
            ...
            <div className="max-w-xs">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-base text-foreground">EasyCred<span className="text-primary">.net</span></span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-16">
              <div>
                <h4 className="text-xs font-semibold text-foreground uppercase tracking-wider mb-3">Produtos</h4>
                <ul className="space-y-2">
                  {products.slice(0, 4).map((p) => (
                    <li key={p.id}>
                      <a href={`/produto/${p.slug}`} className="text-xs text-muted-foreground hover:text-primary transition-colors">
              ...
              <div>
                <h4 className="text-xs font-semibold text-foreground uppercase tracking-wider mb-3">Suporte</h4>
                <ul className="space-y-2">
                  <li>
                    <a href="https://wa.me/5521981672064" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-primary transition-colors flex items-center gap-1.5">
                      <MessageCircle className="w-3 h-3" />
                      WhatsApp
                    </a>
                  </li>
                  <li><a href="#faq" className="text-xs text-muted-foreground hover:text-primary transition-colors">FAQ</a></li>
                  <li><a href="#por-que" className="text-xs text-muted-foreground hover:text-primary transition-colors">Por que EasyCred</a></li>
                </ul>
              </div>
            </div>
          </div>
